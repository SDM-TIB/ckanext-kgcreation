...
setup(
    ...
    description='''CKAN extension developed for Leibniz Data Manager on TIB allowing the creation of Knowledge Graphs over Datasets and a SPARQL Endpoint for querying the data.''',
